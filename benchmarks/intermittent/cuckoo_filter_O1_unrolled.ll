; ModuleID = 'test/intermittent/cuckoo_filter_O1.ll'
...
39:                                               ; preds = %28
  %.lcssa4 = phi i32 [ %35, %28 ]
  %40 = trunc i32 %.lcssa3 to i16
...
53:                                               ; preds = %42
  %.lcssa5 = phi i32 [ %49, %42 ]
  %54 = trunc i32 %.lcssa4 to i16
  %55 = and i16 %54, 255
  call void @llvm.lifetime.end.p0(ptr %5)
  %56 = xor i32 %.lcssa5, %.lcssa4
...
97:                                               ; preds = %86
  %.lcssa6 = phi i32 [ %93, %86 ]
  %98 = trunc i32 %.lcssa6 to i16
  %99 = and i16 %98, 255
  ...
  br i1 %107, label %82, label %.loopexit, !llvm.loop !16

.loopexit:                                        ; preds = %97
  br label %108

108:                                              ; preds = %.loopexit, %69, %63
  %109 = phi i16 [ %13, %63 ], [ %13, %69 ], [ %75, %.loopexit ]
...
141:                                              ; preds = %130
  %.lcssa1 = phi i32 [ %137, %130 ]
  %142 = trunc i32 %.lcssa to i16
...
155:                                              ; preds = %144
  %.lcssa2 = phi i32 [ %151, %144 ]
  %156 = and i32 %.lcssa1, 255
