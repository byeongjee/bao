; ModuleID = 'test/intermittent/cuckoo_filter_unrolled_checkpointed.ll'
...
@checkpoint_name.7 = private unnamed_addr constant [5 x i8] c"bb38\00", align 1
...
47:                                               ; preds = %86, %35
  ...
  call void @__checkpoint(ptr nonnull @checkpoint_name) #4
  %51 = lshr i16 %50, 8
  %52 = mul i16 %50, 33
  %53 = add i16 %52, 69
  %54 = add i16 %53, %51
  ...
  %61 = icmp eq i16 %60, 0
  br i1 %61, label %.loopexit3, label %62, !llvm.loop !12
...
62:                                               ; preds = %47
  ...
  %73 = icmp eq i16 %72, 0
  br i1 %73, label %.loopexit3, label %74, !llvm.loop !12
...
74:                                               ; preds = %62
  ...
  %85 = icmp eq i16 %84, 0
  br i1 %85, label %.loopexit3, label %86, !llvm.loop !12
...
86:                                               ; preds = %74
  ...
  br i1 %101, label %47, label %.loopexit3, !llvm.loop !14

.loopexit3:                                       ; preds = %47, %62, %74, %86
  br label %102

102:                                              ; preds = %.loopexit3, %34, %28
  %103 = phi i16 [ %6, %28 ], [ %6, %34 ], [ %40, %.loopexit3 ]
  call void @__checkpoint(ptr nonnull @checkpoint_name.1) #4
  %104 = mul i16 %8, 17
  %105 = add i16 %104, 17
  %106 = lshr i16 %105, 8
  %107 = and i16 %105, 255
...
142:                                              ; preds = %181, %130
  ...
  call void @__checkpoint(ptr nonnull @checkpoint_name.2) #4
  %146 = lshr i16 %145, 8
  %147 = mul i16 %145, 33
  %148 = add i16 %147, 69
  %149 = add i16 %148, %146
  ...
  br i1 %156, label %.loopexit2, label %157, !llvm.loop !12
...
157:                                              ; preds = %142
  ...
  br i1 %168, label %.loopexit2, label %169, !llvm.loop !12
...
169:                                              ; preds = %157
  ...
  br i1 %180, label %.loopexit2, label %181, !llvm.loop !12
...
181:                                              ; preds = %169
  ...
  br i1 %196, label %142, label %.loopexit2, !llvm.loop !14
...
.loopexit2:                                       ; preds = %142, %157, %169, %181
  br label %199

199:                                              ; preds = %.loopexit2, %198, %197
  %200 = phi i16 [ %103, %198 ], [ %103, %197 ], [ %135, %.loopexit2 ]
  call void @__checkpoint(ptr nonnull @checkpoint_name.3) #4
  %201 = mul i16 %105, 17
  %202 = add i16 %201, 17
  %203 = lshr i16 %202, 8
  %204 = and i16 %202, 255
...
239:                                              ; preds = %278, %227
  ...
  call void @__checkpoint(ptr nonnull @checkpoint_name.4) #4
  %243 = lshr i16 %242, 8
  %244 = mul i16 %242, 33
  %245 = add i16 %244, 69
  %246 = add i16 %245, %243
  ...
  br i1 %253, label %.loopexit1, label %254, !llvm.loop !12
...
254:                                              ; preds = %239
  ...
  br i1 %265, label %.loopexit1, label %266, !llvm.loop !12
...
266:                                              ; preds = %254
  ...
  br i1 %277, label %.loopexit1, label %278, !llvm.loop !12
...
278:                                              ; preds = %266
  ...
  br i1 %293, label %239, label %.loopexit1, !llvm.loop !14
...
.loopexit1:                                       ; preds = %239, %254, %266, %278
  br label %296

296:                                              ; preds = %.loopexit1, %295, %294
  %297 = phi i16 [ %200, %295 ], [ %200, %294 ], [ %232, %.loopexit1 ]
  call void @__checkpoint(ptr nonnull @checkpoint_name.5) #4
  %298 = mul i16 %202, 17
  %299 = add i16 %298, 17
  %300 = lshr i16 %299, 8
  %301 = and i16 %299, 255
...
336:                                              ; preds = %375, %324
  ...
  call void @__checkpoint(ptr nonnull @checkpoint_name.6) #4
  %340 = lshr i16 %339, 8
  %341 = mul i16 %339, 33
  %342 = add i16 %341, 69
  %343 = add i16 %342, %340
  ...
  br i1 %350, label %.loopexit, label %351, !llvm.loop !12
...
351:                                              ; preds = %336
  ...
  br i1 %362, label %.loopexit, label %363, !llvm.loop !12
...
363:                                              ; preds = %351
  ...
  br i1 %374, label %.loopexit, label %375, !llvm.loop !12
...
375:                                              ; preds = %363
  ...
  br i1 %390, label %336, label %.loopexit, !llvm.loop !14
...
.loopexit:                                        ; preds = %336, %351, %363, %375
  br label %393

393:                                              ; preds = %.loopexit, %392, %391
  %394 = phi i16 [ %297, %392 ], [ %297, %391 ], [ %329, %.loopexit ]
  call void @__checkpoint(ptr nonnull @checkpoint_name.7) #4
...
416:                                              ; preds = %398
  call void @__checkpoint(ptr nonnull @checkpoint_name.8) #4
  %417 = mul i16 %407, 33
  %418 = add i16 %417, 69
  %419 = lshr i16 %407, 8
  %420 = add i16 %418, %419
...
427:                                              ; preds = %416, %398
  call void @__checkpoint(ptr nonnull @checkpoint_name.9) #4
...
476:                                              ; preds = %460
  call void @__checkpoint(ptr nonnull @checkpoint_name.10) #4
  %477 = mul i16 %467, 33
  %478 = add i16 %477, 69
  %479 = lshr i16 %467, 8
  %480 = add i16 %478, %479
...
487:                                              ; preds = %476, %460
  call void @__checkpoint(ptr nonnull @checkpoint_name.11) #4
