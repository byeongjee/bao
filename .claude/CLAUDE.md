...
ckpt compile milp      INPUT -e CONFIG -m CONFIG [--link] [--estimator-mode assembly|ir] ...
ckpt compile rockclimb INPUT -e CONFIG -c CONFIG [--link] [--no-precomputed-energy] ...
ckpt compile schematic INPUT -e CONFIG -s CONFIG [--link] [--trace FILE] [--trace-only] ...
ckpt compile run       INPUT --mode milp|rockclimb|schematic|none [--flash-only] [--compile-only] ...
