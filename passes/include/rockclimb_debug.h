...
/* Newlib syscall: printf -> _write/_write_r */
static inline int _write(int fd, const void *buf, size_t n) {
    (void)fd;
...
static inline int _write_r(struct _reent *r, int fd, const void *buf, size_t n) {
    (void)r;
