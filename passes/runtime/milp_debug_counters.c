/*
 * MILP Debug Counters Runtime (MSP430)
 *
 * Links ALONGSIDE milp_boot.S + milp_runtime.c (not replacing them).
 * Provides UART output for profiling.
 *
 * Counter globals are defined in milp_runtime.c (extern here):
 *   cnt_boundary — incremented in assembly (__region_boundary)
 ...
 * TODO: Register spilling may cause divergence between vreg counts and
 * actual physical register save/restore counts.
 *
...
/* ============================================================================
 * NVM Debug Counters (defined in milp_runtime.c, extern here)
 * ============================================================================ */

extern uint16_t cnt_boundary;
extern uint16_t cnt_save_vreg;
extern uint16_t cnt_restore_vreg;
